...
pub const ENV: &str = "CarRacing-v0";
pub const REQUIRED_FITNESS: f64 = 900.0;
...
fn run(
    ...
    let mut fitness = 0.0;
    let mut all_observations = Array2::zeros((1, 27648));
    /* s */
    ...
    for run in 0..runs {
        ...
        for step in 0..steps {
            ...
            observations = Array::from(observations.into_raw_vec());
